...
const Signin = () => {
  ...
  const [user, setUser] = useState({
    ...
    return (
      <div className="w-full min-h-[100vh] flex flex-col items-center justify-center text-black bg-amber-300 py-4">
          <div className="w-[90%]">
          ...
          <button className="bg-orange-400 hover:shadow-black/60 hover:shadow-lg transition-all shadow-md shadow-black/50 my-3 text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline" type="submit">
            Inicia sesión
          </button>
          <a
            className="inline-block align-baseline font-bold mt-4 text-blue-700 hover:text-blue-900"
            href="#!"
